...
import com.vijay.learn.spring.jdbctemplate.dao.impl.NamedParamJdbcTemplateStockDAOImpl;
...
public class NamedParameterJdbcTemplateStockClient {
    public static void main(String[] args) {
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(ApplicationConfig.class);

        StockDAO stockDAO = context.getBean(NamedParamJdbcTemplateStockDAOImpl.class);
